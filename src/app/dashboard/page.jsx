            ...
            <div className='col col-lg-5 col-md-5 col-sm-12 col-12'>
                <div className='row'>
                    ...
                    <div className='col col-lg-4 col-md-4 col-sm-4 col-4 sign-text'>
                        {test == true ?(<button onClick={handleGooLogout} ><Image alt='..' src={session.user.image} width="100" height="100" className={styles.signoutimage}></Image></button>):(<button className={styles.signoutimage} onClick={handleLogout}>Logout</button>)}
                    </div>
                </div>
